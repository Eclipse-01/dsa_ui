        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">数据显示异常</h3>
                <ul className="list-disc pl-6 mt-2 text-gray-600">
                  <li>检查数据源连接是否正常</li>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">系统响应缓慢</h3>
                <ul className="list-disc pl-6 mt-2 text-gray-600">
                  <li>检查网络连接状态</li>
                  <li>适当调整数据采集频率</li>
                  <li>优化数据查询条件</li>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">权限相关问题</h3>
                <ul className="list-disc pl-6 mt-2 text-gray-600">
                  <li>确认当前用户权限级别</li>
                  <li>联系系统管理员调整权限</li>
                  <li>查看操作日志排查问题</li>
